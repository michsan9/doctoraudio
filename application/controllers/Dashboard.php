...
class Dashboard extends CI_Controller {
	...
	public function detail($kode_transaksi)
	{
		...
		if($header_transaksi->id_pelanggan != $id_pelanggan){
			$this->session->set_flashdata('warning', 'Jangan coba coba');
	...
	public function profil(){
		...
		$this->load->view('layout/wrapper', $data, FALSE);
			...
			$this->session->set_flashdata('sukses', 'Update Profil Berhaisl');
	...
	public function konfirmasi($kode_transaksi)
	{
		...
		$this->load->view('layout/wrapper', $data, FALSE);
			...
			$this->session->set_flashdata('sukses', 'Data Konfirmasi Berhasil dilakukan');
		...
		$data = array( 'title'	=> 'Konfrimasi Pembayaran',
					'header_transaksi' => $header_transaksi,
					'rekening'	=> $rekening,
					'isi'	=>	'dashboard/konfirmasi'	   	
						);
