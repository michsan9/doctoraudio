<!-- Title Page -->
	<section class="parallax0 parallax100" style="background-image: url(<?php echo base_url()?>asset/img/paket.jpg);">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative ">
									<img height="250" width="300" src="<?php echo base_url('asset/upload/image/thumbs/' .$produk->gambar) ?>" alt="IMG-PRODUCT">
