		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="<?php echo base_url('asset/upload/image/thumbs/' .$produk->gambar) ?>">
						...
						<div class="item-slick3" data-thumb="<?php echo base_url('asset/upload/image/thumbs/' .$gambar->gambar) ?>">
							<div class="wrap-pic-w">
								<img src="<?php echo base_url('asset/upload/image/' .$gambar->gambar) ?>" alt="IMG-PRODUCT">
							</div>
						</div>
					<?php }} ?>
					...
					<div class="flex-r-m flex-w p-t-10">
						<div class="w-size16 flex-m flex-w">
							<div class="flex-w bo5 of-hidden m-r-22 m-t-10 m-b-10">
								...
								<input class="size8 m-text18 t-center num-product" name="qty" value="1">
	...
	<section class="product_description_area">
		<div class="container">
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Deskripsi Produk</a>
				</li>
				<li class="nav-item">
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td>
										<h5><?php echo $produk->tanggal_post ?></h5>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<h5><?php echo $produk->keywords ?></h5>
									</td>
								</tr>
					...
					?>
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="<?php echo base_url('asset/upload/image/' .$produk_related->gambar) ?>" alt="<?php echo $produk_related->nama_produk ?>">
