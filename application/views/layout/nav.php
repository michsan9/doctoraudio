	...
	<div class="wrap_header">
				...
				<a href="<?php echo base_url() ?>" class="logo">
							<img src="<?php echo base_url('asset/upload/image/' .$site->logo) ?>" alt="IMG-LOGO">
				</a>
				...
				<div class="header-icons">
					...
					<a href="<?php echo base_url('dashboard') ?>" class="header-wrapicon1 dis-block">
						<img src="<?php echo base_url() ?>asset/depan/images/icons/icon-header-01.png" class="header-icon1" alt="ICON"><?php echo $this->session->userdata('nama_pelanggan'); ?>
					</a>
					
				<?php }else{ ?>

					<a href="<?php echo base_url('registrasi') ?>" class="header-wrapicon1 dis-block">
						<img src="<?php echo base_url() ?>asset/depan/images/icons/icon-header-01.png" class="header-icon1" alt="ICON">
					</a>
				<?php } ?>
					...
					<div class="header-wrapicon2">
						...
						$keranjang = $this->cart->contents();
						 ...
						 ?>
						<img src="<?php echo base_url() ?>asset/depan/images/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="ICON">
						...
						<div class="header-cart header-dropdown">
							<ul class="header-cart-wrapitem">
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="<?php echo base_url('asset/upload/image/thumbs/' .$produknya->gambar) ?>" alt="IMG">
									</div>
							...
							<?php if(!empty($keranjang)) { echo $total; } ?>
							</div>
			...
			<div class="btn-show-menu">
				...
				<?php } ?>
					...
					<div class="header-wrapicon2">
						...
						$mobile = $this->cart->contents();


						 ?>
						<img src="<?php echo base_url() ?>asset/depan/images/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="ICON">
						<span class="header-icons-noti"><?php echo count($mobile) ?></span>
								...
								if (empty($mobile)) {?>
									...
									<?php }else{ 
										...
										foreach($mobile as $mobile){
											$id_produk_mobile =$mobile['id'];
											$produk_mobile =$this->produk_model->detail($id_produk_mobile);

										?>	
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="<?php echo base_url('asset/upload/image/thumbs/' .$produk_mobile->gambar) ?>" alt="IMG">
									</div>
									...
									<div class="header-cart-item-txt">
										...
										<span class="header-cart-item-info">
											<?php echo $mobile['qty'] ?> x Rp. <?php echo number_format($mobile['price'],'0',',','.')  ?> = Rp. <?php echo number_format($mobile['subtotal'],'0',',','.') ?>
										</span>
									</div>
								</li>
		...
		<div class="wrap-side-menu" >
			<nav class="side-menu">
				<ul class="main-menu">
					...
					<li class="item-menu-mobile">
						<a href="<?php echo base_url() ?>">Produk &amp; Belanja</a>
						<ul class="sub-menu">

								<?php foreach($nav_mobile as $nav_mobile) { ?>
									<li><a href="<?php echo base_url('produk/kategori/' .$nav_mobile->slug_kategori) ?>"><?php echo $nav_mobile->nama_kategori ?>
									</a></li>
									<?php } ?>
